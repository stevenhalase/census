...
function mainController($http) {
  ...
  mCtrl.getData = function() {
    ...
    var mapquestQuery = 'https://www.mapquestapi.com/geocoding/v1/address?key=Q6kWF9IYQkgFceAaU4R1prbAeWkzMVLr&inFormat=json&json={"location":{"street": "' + mCtrl.street + '","city":"' + mCtrl.city + '","state":"' + mCtrl.state + '"}}'
    ...
    $http.get(mapquestQuery)
      .then(function(response) {
        ...
        $http.get('https://census.codeforamerica.org/areas?lat=' + lat + '&lon=' + lng + '&layers=state,county,cbsa,zcta510')
